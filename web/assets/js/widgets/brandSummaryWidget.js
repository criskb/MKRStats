export function mountBrandSummaryWidget(container, data) {
  ...
  container.innerHTML = `
    <div class="brand-summary">
      ...
      <p><strong>Collection Coverage:</strong> <a href="#collection-health-details">${collection.platformCoveragePct ?? 0}%</a></p>
      <p><strong>Estimated Data Points:</strong> <a href="#collection-health-details">${(collection.estimatedDataPoints ?? 0).toLocaleString()}</a></p>
